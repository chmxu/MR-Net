...
import image_data
from image_data_aug import AugmentPoseDataset
        ...
        for name, module in self.vgg_layers._modules.items():
            ...
            if name in self.layers_mapping:
                if use_roi:
                    ...
                    masked_output[self.layers_mapping[name]] = roi_pooling(x, target_bbox, size=self.roi_size[roi_cnt], spatial_scale=spatial_scale)
                    roi_cnt += 1
